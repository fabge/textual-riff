...
from textual.document._document import Document, DocumentBase, EditResult, Location, Selection
...
from textual.widgets._text_area import EndColumn, Highlight, HighlightName, LanguageDoesNotExist, StartColumn, ThemeDoesNotExist
