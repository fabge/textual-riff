...
from typing import TYPE_CHECKING, AsyncGenerator, ClassVar, Collection, Generator, Iterable, NamedTuple, Sequence, TypeVar, cast, overload
...
from textual.geometry import NULL_REGION, NULL_SIZE, NULL_SPACING, Offset, Region, Size, Spacing, clamp
...
if TYPE_CHECKING:
    ...
    from textual.scrollbar import ScrollBar, ScrollBarCorner, ScrollDown, ScrollLeft, ScrollRight, ScrollTo, ScrollUp
